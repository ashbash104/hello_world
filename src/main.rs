...
fn yet_another_function(value: i32, label: char){
...
fn dot(
    ...
    // specified.
    let mut dot = Mesh::new(PrimitiveTopology::TriangleList);
    ...
    dot.insert_attribute(Mesh::ATTRIBUTE_POSITION, v_pos);
    ...
    dot.set_indices(Some(Indices::U32(indices)));
